...
export default function WeatherIcon({ kind, size = 16 }) {
  ...
  switch (kind) {
    case 'sunny':
      return (
        <svg viewBox="0 0 24 24" style={s} aria-label="Sunny">
    ...
    case 'cloudy':
      return (
        <svg viewBox="0 0 24 24" style={s} aria-label="Cloudy">
          <path d="M7 18a4 4 0 0 1 0-8 5 5 0 0 1 9.6 1.3A3.5 3.5 0 0 1 17 18z" fill="#9aa6b2" />
        </svg>
      )
    case 'rainy':
      return (
        <svg viewBox="0 0 24 24" style={s} aria-label="Rainy">
    ...
    case 'domed':
      return (
        <svg viewBox="0 0 24 24" style={s} aria-label="Domed / roof closed">
